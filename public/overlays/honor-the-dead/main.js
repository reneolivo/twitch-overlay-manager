class HonorTheDeadRewardHandler {
  ...
  static audio = new Audio('/overlays/honor-the-dead/assets/rest-in-peace.mp3');
  static tombImg = '<img class="rewards__tomb" src="/overlays/honor-the-dead/assets/tomb.png" />';
  ...
  static runUserAnimation(data) {
    ...
    const avatar = `<img src="/overlays/honor-the-dead/assets/respect-avatars/respect${randomNumber}.jpg" />`;
